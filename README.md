...
健保特約醫院於 VPN 登錄的**白班／小夜／大夜**急性一般病床護病比，477 家、民國 112/07–115/07 逐月資料。依醫院層級套用達標標準，分級標示合規情形；多院區各院區分別呈現。
...
**送出後資料立即公開**，沒有後台人工審核延遲。短評與特殊福利欄位會在送出當下經 AI 自動檢查，判定可能違規時只在平台上以模糊呈現＋標示理由（瀏覽者可展開），不擋下投稿、其餘欄位照常公開，詳見 [docs/moderation.md](docs/moderation.md)。但同時也代表：
...
| `build-forms.py` | `templates/participate-form.html`＋`templates/forms.json` → 5 個表單頁 `participate-<slug>.html`；**改表單頁共用部分請改樣板** |
