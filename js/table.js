// 表格 / 卡片 渲染、排序、Modal
import { CATEGORIES, COMMON_FIELDS, getCategory, getAllFields } from './config.js?v=33720318e3';
import { fmt, recommendPill, categoryTag } from './components.js?v=33720318e3';
import { icon } from './icons.js?v=33720318e3';
import { generateShareCard, showSharePreview } from './share-card.js?v=33720318e3';
import { ensureTooltip } from './tooltip.js?v=33720318e3';
import { pageSlice, renderPagination } from './pagination.js?v=33720318e3';
import { getHospitalCode, getShort, getShortByCode } from './hospital-shortname.js?v=33720318e3';
import { commentHtml, commentCellHtml, initCommentUnlock, isBlocked, escapeHtml } from './moderation.js?v=33720318e3';
          ...
          <div class="data-card" data-idx="${idx}">
            ...
            ${r.comment ? `
              <div class="data-card-comment">
                ...
                <div class="comment-text">${commentHtml(r, { compact: true })}</div>
              </div>` : ''}
          </div>
        `; }).join('')
      }
