...
import { getShort as getHospitalShort } from './hospital-shortname.js?v=0fa1ef9a9a';
import { normalizeInstitutionName } from './institution-name.js?v=0fa1ef9a9a';
...
import { icon, renderIcons } from './icons.js?v=0fa1ef9a9a';
