...
import { CATEGORIES } from './config.js?v=ecc88dff27';

// 記憶體 cache：同 session 內不重抓
const cache = new Map();

// localStorage cache 設定
const CACHE_VERSION = 'v12';                 // v12: 加護病房班別新增「混合制」+ mock 全量重跑（ICU 160 筆）；v11: 新增第 10 類「診所」；v10: mock 資料擴充；v9: 推薦指數 1-5 + 精神科
