...
export const CATEGORIES = [
  {
    ...
    color: '#F4A261',
    accent: '#FCE2C8',
    description: '一般病房護理，含內科、外科、婦產、兒科、安寧等多種屬性，是護理人力配置的主力。',
    icon: 'bed',
  ...
  },
  {
    ...
    color: '#E63946',
    accent: '#FAD2CF',
    description: '從檢傷、急救到留觀同時運轉，病情與人流難以預測，是醫院裡步調最緊湊的第一線。',
    icon: 'siren',
  ...
  },
  {
    ...
    color: '#FF6B9D',
    accent: '#FDD5E2',
    description: '涵蓋刷手、流動、麻醉協助與恢復室照護，是手術全程不可或缺的一環。',
    icon: 'scissors',
  ...
  },
  {
    ...
    color: '#9D4EDD',
    accent: '#E0CFF7',
    description: '從診所到醫學中心規模落差極大，工作橫跨看診協助、檢查、衛教與行政事務。',
    icon: 'calendar-check',
  ...
  },
  {
    ...
    color: '#64748B',
    accent: '#D1D9E2',
    description: '不屬於前述場域的護理職務都歸在這裡：專科護理師、居家／社區護理、長照、學校、月子中心、公衛，以及廠護／職護、臨床研究（CRA／CRC）、藥廠醫材等較少被看見的護理職涯。',
