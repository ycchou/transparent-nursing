...
import { SITE, CATEGORIES } from './config.js?v=17c370612b';
import { icon, renderIcons } from './icons.js?v=17c370612b';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=17c370612b';
