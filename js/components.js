...
import { SITE, CATEGORIES } from './config.js?v=bdf0f5193d';
import { icon, renderIcons } from './icons.js?v=bdf0f5193d';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=bdf0f5193d';
import { initScrollHints } from './scroll-hint.js?v=bdf0f5193d';
import { mountModeBadge } from './env.js?v=bdf0f5193d';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=bdf0f5193d')
