...
import { SITE, CATEGORIES } from './config.js?v=dc3b75cdb2';
import { icon, renderIcons } from './icons.js?v=dc3b75cdb2';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=dc3b75cdb2';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=dc3b75cdb2')
