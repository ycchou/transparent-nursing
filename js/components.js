...
import { SITE, CATEGORIES } from './config.js?v=0fa1ef9a9a';
import { icon, renderIcons } from './icons.js?v=0fa1ef9a9a';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=0fa1ef9a9a';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=0fa1ef9a9a')
