...
import { SITE, CATEGORIES } from './config.js?v=3c903d8cc4';
import { icon, renderIcons } from './icons.js?v=3c903d8cc4';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=3c903d8cc4';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=3c903d8cc4')
