...
import { SITE, CATEGORIES } from './config.js?v=01e7db4caf';
import { icon, renderIcons } from './icons.js?v=01e7db4caf';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=01e7db4caf';
