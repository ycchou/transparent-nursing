...
import { SITE, CATEGORIES } from './config.js?v=84f6322831';
import { icon, renderIcons } from './icons.js?v=84f6322831';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=84f6322831';
