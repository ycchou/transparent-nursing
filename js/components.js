...
import { SITE, CATEGORIES } from './config.js?v=afdc52b469';
import { icon, renderIcons } from './icons.js?v=afdc52b469';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=afdc52b469';
