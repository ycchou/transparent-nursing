...
import { SITE, CATEGORIES } from './config.js?v=b7340baddb';
import { icon, renderIcons } from './icons.js?v=b7340baddb';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=b7340baddb';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=b7340baddb')
