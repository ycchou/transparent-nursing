...
import { SITE, CATEGORIES } from './config.js?v=34019d6b69';
import { icon, renderIcons } from './icons.js?v=34019d6b69';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=34019d6b69';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=34019d6b69')
