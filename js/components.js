...
import { SITE, CATEGORIES } from './config.js?v=2157fab129';
import { icon, renderIcons } from './icons.js?v=2157fab129';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=2157fab129';
