...
import { SITE, CATEGORIES } from './config.js?v=e5dd93de1c';
import { icon, renderIcons } from './icons.js?v=e5dd93de1c';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=e5dd93de1c';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=e5dd93de1c')
