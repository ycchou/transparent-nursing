...
import { SITE, CATEGORIES } from './config.js?v=fd737669bd';
import { icon, renderIcons } from './icons.js?v=fd737669bd';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=fd737669bd';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=fd737669bd')
