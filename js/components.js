...
import { SITE, CATEGORIES } from './config.js?v=2118043f0b';
import { icon, renderIcons } from './icons.js?v=2118043f0b';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=2118043f0b';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=2118043f0b')
