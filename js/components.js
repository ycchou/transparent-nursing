...
import { SITE, CATEGORIES } from './config.js?v=28ce4a4ed6';
import { icon, renderIcons } from './icons.js?v=28ce4a4ed6';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=28ce4a4ed6';
