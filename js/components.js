...
import { SITE, CATEGORIES } from './config.js?v=ea7daf2bd0';
import { icon, renderIcons } from './icons.js?v=ea7daf2bd0';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=ea7daf2bd0';
import { initScrollHints } from './scroll-hint.js?v=ea7daf2bd0';
import { mountModeBadge } from './env.js?v=ea7daf2bd0';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=ea7daf2bd0')
