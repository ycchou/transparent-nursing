...
import { SITE, CATEGORIES } from './config.js?v=f043d4791a';
import { icon, renderIcons } from './icons.js?v=f043d4791a';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=f043d4791a';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=f043d4791a')
