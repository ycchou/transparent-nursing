...
import { SITE, CATEGORIES } from './config.js?v=1957ae4d1f';
import { icon, renderIcons } from './icons.js?v=1957ae4d1f';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=1957ae4d1f';
