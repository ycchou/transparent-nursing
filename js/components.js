...
import { SITE, CATEGORIES } from './config.js?v=9bc2c481e9';
import { icon, renderIcons } from './icons.js?v=9bc2c481e9';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=9bc2c481e9';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=9bc2c481e9')
