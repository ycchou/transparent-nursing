...
import { SITE, CATEGORIES } from './config.js?v=c1fc9f9fa9';
import { icon, renderIcons } from './icons.js?v=c1fc9f9fa9';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=c1fc9f9fa9';
