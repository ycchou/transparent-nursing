...
import { SITE, CATEGORIES } from './config.js?v=fc32ea82a0';
import { icon, renderIcons } from './icons.js?v=fc32ea82a0';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=fc32ea82a0';
import { initScrollHints } from './scroll-hint.js?v=fc32ea82a0';
import { mountModeBadge } from './env.js?v=fc32ea82a0';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=fc32ea82a0')
