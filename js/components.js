...
import { SITE, CATEGORIES } from './config.js?v=d5f792af4d';
import { icon, renderIcons } from './icons.js?v=d5f792af4d';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=d5f792af4d';
