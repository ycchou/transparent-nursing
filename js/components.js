...
import { SITE, CATEGORIES } from './config.js?v=61fd87da63';
import { icon, renderIcons } from './icons.js?v=61fd87da63';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=61fd87da63';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=61fd87da63')
