...
import { SITE, CATEGORIES } from './config.js?v=fbf38edc70';
import { icon, renderIcons } from './icons.js?v=fbf38edc70';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=fbf38edc70';
