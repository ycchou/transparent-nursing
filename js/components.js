...
import { SITE, CATEGORIES } from './config.js?v=2eb60ed8b0';
import { icon, renderIcons } from './icons.js?v=2eb60ed8b0';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=2eb60ed8b0';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=2eb60ed8b0')
