...
import { SITE, CATEGORIES } from './config.js?v=b18fe7a50a';
import { icon, renderIcons } from './icons.js?v=b18fe7a50a';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=b18fe7a50a';
