...
import { SITE, CATEGORIES } from './config.js?v=a3713af653';
import { icon, renderIcons } from './icons.js?v=a3713af653';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=a3713af653';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=a3713af653')
