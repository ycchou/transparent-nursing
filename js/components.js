...
import { SITE, CATEGORIES } from './config.js?v=75634a51d3';
import { icon, renderIcons } from './icons.js?v=75634a51d3';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=75634a51d3';
