...
import { SITE, CATEGORIES } from './config.js?v=55355b0273';
import { icon, renderIcons } from './icons.js?v=55355b0273';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=55355b0273';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=55355b0273')
