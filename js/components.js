...
import { SITE, CATEGORIES } from './config.js?v=6921db2fae';
import { icon, renderIcons } from './icons.js?v=6921db2fae';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=6921db2fae';
import { initScrollHints } from './scroll-hint.js?v=6921db2fae';
import { mountModeBadge } from './env.js?v=6921db2fae';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=6921db2fae')
