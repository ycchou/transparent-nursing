...
import { SITE, CATEGORIES } from './config.js?v=3eafcab1f5';
import { icon, renderIcons } from './icons.js?v=3eafcab1f5';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=3eafcab1f5';
import { initScrollHints } from './scroll-hint.js?v=3eafcab1f5';
import { mountModeBadge } from './env.js?v=3eafcab1f5';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=3eafcab1f5')
