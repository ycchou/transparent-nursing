...
import { SITE, CATEGORIES } from './config.js?v=5dc6864f4d';
import { icon, renderIcons } from './icons.js?v=5dc6864f4d';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=5dc6864f4d';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=5dc6864f4d')
