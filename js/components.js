...
import { SITE, CATEGORIES } from './config.js?v=f609aa5aa4';
import { icon, renderIcons } from './icons.js?v=f609aa5aa4';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=f609aa5aa4';
