...
import { SITE, CATEGORIES } from './config.js?v=8f9cf82f88';
import { icon, renderIcons } from './icons.js?v=8f9cf82f88';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=8f9cf82f88';
