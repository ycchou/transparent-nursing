...
import { SITE, CATEGORIES } from './config.js?v=196247a243';
import { icon, renderIcons } from './icons.js?v=196247a243';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=196247a243';
