...
import { SITE, CATEGORIES } from './config.js?v=ecc88dff27';
import { icon, renderIcons } from './icons.js?v=ecc88dff27';
import { initPWAPrompt, showInstallGuide, isAppInstalled } from './pwa-prompt.js?v=ecc88dff27';
...
export function mountLayout() {
  ...
  import('./data-loader.js?v=ecc88dff27')
